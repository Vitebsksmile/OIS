...
class FileHandler : public QObject
{
    ...
    Q_PROPERTY(QUrl currentImagePath
                   READ currentImagePath
                       NOTIFY currentImagePathChanged)
    ...
    Q_PROPERTY(bool directionOut
                   READ directionOut
                       WRITE setDirectionOut
                           NOTIFY directionOutChanged)
